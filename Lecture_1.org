...
The Comprehensive R Archive Network (CRAN) https://cran.r-project.org/. CRAN is a network of ftp and web servers around the world that store identical, up-to-date, versions of code and documentation for R. 
