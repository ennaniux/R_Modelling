...
For real values -∞ ≦ x ≦ ∞, -∞ ≦ \mu ≦ ∞ and  0 ≦ \sigma ≦ ∞, the normal distribution has probability density function:
...
Suppose that Z ∼ N(0, 1). Using the probability density function and the definition, show that Var[Z] = 1. 
